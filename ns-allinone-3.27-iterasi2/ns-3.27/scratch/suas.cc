...
Ipv4InterfaceContainer j = ipv4.Assign(fakeDevices);
  ...
  /*Setting titik di NetAnim - Iterasi 2*/
  anm.SetConstantPosition(c.Get(0),-21.757376, 307.252459);
  anm.SetConstantPosition(c.Get(1),634.315654, 934.315654);
  anm.SetConstantPosition(c.Get(2),-51.689339, 289.662132);
  anm.SetConstantPosition(c.Get(3),-139.360504, 160.639496);
  anm.SetConstantPosition(c.Get(4),-283.904432, 178.326672);
  anm.SetConstantPosition(c.Get(5),000.0, 300.0);
  anm.SetConstantPosition(c.Get(6),47.208556, 536.042781);
  anm.SetConstantPosition(c.Get(7),-100.094001, 199.905999);
  anm.SetConstantPosition(c.Get(8),-70.539218, 323.513073);
  anm.SetConstantPosition(c.Get(9),-166.10324, 133.89676);
