...
Ipv4InterfaceContainer j = ipv4.Assign(fakeDevices);
  ...
  /*Setting titik di NetAnim - Iterasi 3*/
  anm.SetConstantPosition(c.Get(0),-253.936444 , 303.106789);
  anm.SetConstantPosition(c.Get(1),2.08809247 , 578.421221);
  anm.SetConstantPosition(c.Get(2),-415.267617, 215.165507);
  anm.SetConstantPosition(c.Get(3),-497.309084, -56.052354);
  anm.SetConstantPosition(c.Get(4),-746.938714,  -20.116592);
  anm.SetConstantPosition(c.Get(5),-92.784426, 260.235246);
  anm.SetConstantPosition(c.Get(6),-190.367674 , 135.171375);
  anm.SetConstantPosition(c.Get(7),-225.93721  , 108.370643);
  anm.SetConstantPosition(c.Get(8),-282.921361, 294.758772);
  anm.SetConstantPosition(c.Get(9),-454.8663, -81.860533);
